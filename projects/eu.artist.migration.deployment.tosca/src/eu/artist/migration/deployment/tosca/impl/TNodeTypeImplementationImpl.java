 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getDerivedFrom <em>Derived From</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getRequiredContainerFeatures <em>Required Container Features</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getImplementationArtifacts <em>Implementation Artifacts</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getDeploymentArtifacts <em>Deployment Artifacts</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getNodeType <em>Node Type</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImplementationImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
