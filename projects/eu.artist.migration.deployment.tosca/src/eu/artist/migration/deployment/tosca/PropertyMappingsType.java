 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.PropertyMappingsType#getPropertyMapping <em>Property Mapping</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getPropertyMappingsType()
...
public interface PropertyMappingsType extends EObject {
	 ...
	 * The list contents are of type {@link eu.artist.migration.deployment.tosca.TPropertyMapping}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getPropertyMappingsType_PropertyMapping()
