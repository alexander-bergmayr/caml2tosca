 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.PoliciesType1#getPolicy <em>Policy</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getPoliciesType1()
...
public interface PoliciesType1 extends EObject {
	 ...
	 * The list contents are of type {@link eu.artist.migration.deployment.tosca.TPolicy}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getPoliciesType1_Policy()
