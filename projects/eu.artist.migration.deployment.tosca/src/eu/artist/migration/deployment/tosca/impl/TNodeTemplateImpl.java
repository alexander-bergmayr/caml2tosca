 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTemplateImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTemplateImpl#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTemplateImpl#getPolicies <em>Policies</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTemplateImpl#getDeploymentArtifacts <em>Deployment Artifacts</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTemplateImpl#getMaxInstances <em>Max Instances</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTemplateImpl#getMinInstances <em>Min Instances</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTemplateImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
