 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.NodeTypeReferenceType#getTypeRef <em>Type Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getNodeTypeReferenceType()
...
public interface NodeTypeReferenceType extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getNodeTypeReferenceType_TypeRef()
	...
	/**
	 * Sets the value of the '{@link eu.artist.migration.deployment.tosca.NodeTypeReferenceType#getTypeRef <em>Type Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
