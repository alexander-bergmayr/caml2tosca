 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTemplateImpl#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTemplateImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTemplateImpl#getRelationshipConstraints <em>Relationship Constraints</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTemplateImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
