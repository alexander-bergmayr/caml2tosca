 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.TImplementationArtifacts#getImplementationArtifact <em>Implementation Artifact</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTImplementationArtifacts()
...
public interface TImplementationArtifacts extends EObject {
	 ...
	 * The list contents are of type {@link eu.artist.migration.deployment.tosca.ImplementationArtifactType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTImplementationArtifacts_ImplementationArtifact()
