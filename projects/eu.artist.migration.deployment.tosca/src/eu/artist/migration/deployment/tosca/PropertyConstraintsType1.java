 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.PropertyConstraintsType1#getPropertyConstraint <em>Property Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getPropertyConstraintsType1()
...
public interface PropertyConstraintsType1 extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getPropertyConstraintsType1_PropertyConstraint()
