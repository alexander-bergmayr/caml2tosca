 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TExportedOperationImpl#getNodeOperation <em>Node Operation</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TExportedOperationImpl#getRelationshipOperation <em>Relationship Operation</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TExportedOperationImpl#getPlan <em>Plan</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TExportedOperationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
