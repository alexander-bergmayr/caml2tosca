 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.InterfacesType#getInterface <em>Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getInterfacesType()
...
public interface InterfacesType extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getInterfacesType_Interface()
