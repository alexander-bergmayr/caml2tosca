 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TCapabilityDefinitionImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TCapabilityDefinitionImpl#getCapabilityType <em>Capability Type</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TCapabilityDefinitionImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TCapabilityDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TCapabilityDefinitionImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
