 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.OutputParametersType1#getOutputParameter <em>Output Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getOutputParametersType1()
...
public interface OutputParametersType1 extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getOutputParametersType1_OutputParameter()
