 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.ValidSourceType#getTypeRef <em>Type Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getValidSourceType()
...
public interface ValidSourceType extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getValidSourceType_TypeRef()
	...
	/**
	 * Sets the value of the '{@link eu.artist.migration.deployment.tosca.ValidSourceType#getTypeRef <em>Type Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
