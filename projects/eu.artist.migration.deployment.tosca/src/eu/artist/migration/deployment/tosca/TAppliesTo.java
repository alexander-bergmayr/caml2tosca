 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.TAppliesTo#getNodeTypeReference <em>Node Type Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTAppliesTo()
...
public interface TAppliesTo extends EObject {
	 ...
	 * The list contents are of type {@link eu.artist.migration.deployment.tosca.NodeTypeReferenceType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTAppliesTo_NodeTypeReference()
