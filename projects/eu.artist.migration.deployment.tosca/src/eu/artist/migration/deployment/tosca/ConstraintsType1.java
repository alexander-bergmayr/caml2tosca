 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.ConstraintsType1#getConstraint <em>Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getConstraintsType1()
...
public interface ConstraintsType1 extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getConstraintsType1_Constraint()
