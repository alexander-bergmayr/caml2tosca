 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.RelationshipConstraintType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.RelationshipConstraintType#getConstraintType <em>Constraint Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getRelationshipConstraintType()
...
public interface RelationshipConstraintType extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getRelationshipConstraintType_Any()
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getRelationshipConstraintType_ConstraintType()
	...
	/**
	 * Sets the value of the '{@link eu.artist.migration.deployment.tosca.RelationshipConstraintType#getConstraintType <em>Constraint Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
