 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.CapabilityDefinitionsType#getCapabilityDefinition <em>Capability Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getCapabilityDefinitionsType()
...
public interface CapabilityDefinitionsType extends EObject {
	 ...
	 * The list contents are of type {@link eu.artist.migration.deployment.tosca.TCapabilityDefinition}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getCapabilityDefinitionsType_CapabilityDefinition()
