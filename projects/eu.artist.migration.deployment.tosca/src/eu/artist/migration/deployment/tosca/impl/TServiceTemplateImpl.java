 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TServiceTemplateImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TServiceTemplateImpl#getBoundaryDefinitions <em>Boundary Definitions</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TServiceTemplateImpl#getTopologyTemplate <em>Topology Template</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TServiceTemplateImpl#getPlans <em>Plans</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TServiceTemplateImpl#getId <em>Id</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TServiceTemplateImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TServiceTemplateImpl#getSubstitutableNodeType <em>Substitutable Node Type</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TServiceTemplateImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
