 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.TCondition#getAny <em>Any</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.TCondition#getExpressionLanguage <em>Expression Language</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTCondition()
...
public interface TCondition extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTCondition_Any()
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTCondition_ExpressionLanguage()
	...
	/**
	 * Sets the value of the '{@link eu.artist.migration.deployment.tosca.TCondition#getExpressionLanguage <em>Expression Language</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
