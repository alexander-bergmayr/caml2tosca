 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TEntityTypeImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TEntityTypeImpl#getDerivedFrom <em>Derived From</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TEntityTypeImpl#getPropertiesDefinition <em>Properties Definition</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TEntityTypeImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TEntityTypeImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TEntityTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TEntityTypeImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
