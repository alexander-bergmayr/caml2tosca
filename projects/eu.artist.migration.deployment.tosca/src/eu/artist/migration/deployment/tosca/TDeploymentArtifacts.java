 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.TDeploymentArtifacts#getDeploymentArtifact <em>Deployment Artifact</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTDeploymentArtifacts()
...
public interface TDeploymentArtifacts extends EObject {
	 ...
	 * The list contents are of type {@link eu.artist.migration.deployment.tosca.TDeploymentArtifact}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTDeploymentArtifacts_DeploymentArtifact()
