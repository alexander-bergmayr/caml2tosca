 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.TargetInterfacesType#getInterface <em>Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTargetInterfacesType()
...
public interface TargetInterfacesType extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTargetInterfacesType_Interface()
