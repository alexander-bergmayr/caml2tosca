 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.PoliciesType#getPolicy <em>Policy</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getPoliciesType()
...
public interface PoliciesType extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getPoliciesType_Policy()
