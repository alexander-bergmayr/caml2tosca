 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRequirementDefinitionImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRequirementDefinitionImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRequirementDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRequirementDefinitionImpl#getRequirementType <em>Requirement Type</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRequirementDefinitionImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
