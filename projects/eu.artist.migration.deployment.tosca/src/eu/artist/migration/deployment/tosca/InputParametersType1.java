 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.InputParametersType1#getInputParameter <em>Input Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getInputParametersType1()
...
public interface InputParametersType1 extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getInputParametersType1_InputParameter()
