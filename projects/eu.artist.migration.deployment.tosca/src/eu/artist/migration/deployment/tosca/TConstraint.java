 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.TConstraint#getAny <em>Any</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.TConstraint#getConstraintType <em>Constraint Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTConstraint()
...
public interface TConstraint extends EObject {
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTConstraint_Any()
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getTConstraint_ConstraintType()
	...
	/**
	 * Sets the value of the '{@link eu.artist.migration.deployment.tosca.TConstraint#getConstraintType <em>Constraint Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
