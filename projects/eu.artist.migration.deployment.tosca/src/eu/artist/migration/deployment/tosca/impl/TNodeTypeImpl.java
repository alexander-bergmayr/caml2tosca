 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImpl#getRequirementDefinitions <em>Requirement Definitions</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImpl#getCapabilityDefinitions <em>Capability Definitions</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImpl#getInstanceStates <em>Instance States</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TNodeTypeImpl#getInterfaces <em>Interfaces</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
