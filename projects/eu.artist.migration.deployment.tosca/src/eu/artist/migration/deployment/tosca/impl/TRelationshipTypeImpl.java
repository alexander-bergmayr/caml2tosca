 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTypeImpl#getInstanceStates <em>Instance States</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTypeImpl#getSourceInterfaces <em>Source Interfaces</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTypeImpl#getTargetInterfaces <em>Target Interfaces</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTypeImpl#getValidSource <em>Valid Source</em>}</li>
 *   <li>{@link eu.artist.migration.deployment.tosca.impl.TRelationshipTypeImpl#getValidTarget <em>Valid Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
