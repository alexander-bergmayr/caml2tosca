 ...
 * <ul>
 *   <li>{@link eu.artist.migration.deployment.tosca.RequirementsType#getRequirement <em>Requirement</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getRequirementsType()
...
public interface RequirementsType extends EObject {
	 ...
	 * The list contents are of type {@link eu.artist.migration.deployment.tosca.TRequirement}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.artist.migration.deployment.tosca.ToscaPackage#getRequirementsType_Requirement()
